...
#### lectura de datos
data = pd.read_csv('data_F.csv', engine='python',sep=",") ## Lectura de los datos
palabras = pd.read_csv('palabras_finales.csv', engine='python',sep="|") ## Lectura de los datos
netique=40
etiquetas=palabras[:netique]
data.shape[0]

data_final=pd.DataFrame(columns=('photo_id', 'business_id', 'caption', 'label', 'length', 'stars','len_word'))
